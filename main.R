...
write.csv(df,"Hair_Eye_Color.csv")
print(df)
...
print("Hair col")
hair <- read.csv("Hair_Eye_Color.csv")
hair %>% select(Hair)
...
write.csv(df,"gender_.csv")
print(df)

#Let's 'filter' just the males from our dataset
#TASK: Write the function that includes only rows that are 'male'
HairGender <- read.csv("gender_.csv")
...
male_rows <- read.csv("Male.csv")
female_rows <- read.csv("Female.csv")
inner_join(male_rows, female_rows)
